...
## 함수 선언 부분 ##
def display() : # Code 12-04.py에서 구현 
    pass

def func_open() : # Code 12-04.py에서 구현
    pass

def func_save() : # Code 12-05.py에서 구현
    pass

def func_exit() : 
    exit()

def func_reverse() : # Code 12-06.py에서 구현
    pass

def func_bright() : # Code 12-07.py에서 구현
    pass

def func_dark() : # Code 12-07.py에서 구현
    pass

def func_gray() : # Code 12-08.py에서 구현
    pass
 
def func_bw1() : # Code 12-08.py에서 구현
    pass

def func_bw2() : # Code 12-08.py에서 구현
    pass

def func_mirror1() : # Code 12-09.py에서 구현
    pass

def func_mirror2() : # Code 12-09.py에서 구현
    pass

def func_rotate(times) : # Code 12-10.py에서 구현
    pass

def func_zoomin() : # Code 12-11.py에서 구현
    pass

def func_zoomout() : # Code 12-11.py에서 구현
    pass
